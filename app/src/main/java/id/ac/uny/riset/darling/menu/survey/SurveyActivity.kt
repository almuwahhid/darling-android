...
import id.ac.uny.riset.darling.data.model.*
...
class SurveyActivity : BaseActivity(), SurveyInterface.View {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        supportActionBar!!.setTitle("Answer Me!")
                ...
                override fun onDialogConfirmClick() {
                    if(isSurveyDone){
                        DialogConfirm(context, survey_message, "Terima Kasih", R.drawable.ic_success, object : DialogConfirm.OnDialogConfirm{
                            override fun onDialogConfirmClick() {
                                DialogConfirm(context, "Bagus! Kamu telah selesai merespon. Apakah kamu akan melanjutkan untuk memulai intervensi!", "Okay, Lihat tugas", R.drawable.ic_rating, object : DialogConfirm.OnDialogConfirm{
                                    override fun onDialogConfirmClick() {

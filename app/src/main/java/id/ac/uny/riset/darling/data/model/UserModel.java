...
public class UserModel {
    public String id_user, email, password, nama, jenis_kelamin, tgl_lahir, fakultas, alamat_asal, alamat_tinggal, agama, no_wa, confirmation_code, aktif, id_status, nama_status;
    ...
    public void setUserModel(String email, String password, String nama, String jenis_kelamin, String fakultas, String alamat_asal, String alamat_tinggal, String no_wa, String id_status) {
        this.email = email;
        this.password = password;
        this.nama = nama;
        this.jenis_kelamin = jenis_kelamin;
    ...
    public void setUserModel(String email, String password, String nama, String jenis_kelamin, String fakultas, String alamat_asal, String alamat_tinggal, String no_wa) {
        this.email = email;
        this.password = password;
        this.nama = nama;
        this.jenis_kelamin = jenis_kelamin;

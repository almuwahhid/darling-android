...
import id.ac.uny.riset.darling.data.Preferences
...
import id.ac.uny.riset.darling.menu.register.RegisterActivity
import id.ac.uny.riset.darling.utils.Function
import id.ac.uny.riset.darling.utils.dialogs.DialogLupaPassword.DialogLupaPassword
...
//        finish()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        handler.postDelayed({
            lay_login.show()
            tv_subtitle.visibility = View.INVISIBLE
        }, 2000)

package id.ac.uny.riset.beres.menu.grafik
...
import id.ac.uny.riset.beres.menu.grafik.adapter.GrafikAdapter
...
import id.ac.uny.riset.darling.menu.grafik.GrafikPresenter
import id.ac.uny.riset.darling.menu.grafik.GrafikView
import id.ac.uny.riset.darling.menu.grafik.helper.GrafikHelper
...
class GrafikActivity : BaseActivity(), GrafikView.View {
    ...
    override fun onRequestGrafikNilai(list: MutableList<GrafikUiModel>) {
        ...
        val dataSet = BarDataSet(entries, "Skor Survey")
...
//        yl.setTypeface(tfLight)
        ...
        yl.setAxisMaximum(140f) // this replaces setStartAtZero(true)
        chart1!!.invalidate()
//        yl.setInverted(true);
        ...
        yr.setAxisMaximum(140f) // this replaces setStartAtZero(true)
